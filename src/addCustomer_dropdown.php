...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_POST['CustomerID']) && !empty($_POST['Name'])) {
        ...
        echo "customerID".$_POST['CustomerID'];
         echo "customerName ".$_POST['Name'];
          echo "customerBD ".$_POST['Birthdate'];
           echo "customerEMail ".$_POST['Email'];
            echo "customerctcode ".$_POST['CountryCode'];
             echo "customerOUT ".$_POST['OutstandingDebt'];
             
        $sql = "INSERT INTO cutomer Values (:CustomerID, :Name, :Birthdate, :Email, :CountryCode, :OutstandingDebt)";
